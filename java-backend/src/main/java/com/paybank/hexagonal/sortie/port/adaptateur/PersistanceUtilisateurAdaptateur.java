...
import com.paybank.hexagonal.domaine.service.DroitsService;
import com.paybank.hexagonal.entite.RolePermissionsEntity;
...
@Component
public class PersistanceUtilisateurAdaptateur implements UtilisateurSPI {
    ...
    public PersistanceUtilisateurAdaptateur(UtilisateurRepository utilisateurRepository) {
