...
import com.paybank.hexagonal.port.*;
...
@Service
public class PaiementImplementationService implements ExecutionPaiementSPI {
    ...
    public PaiementImplementationService(PersistancePaiementSPI persistancePaiementSPI, PasserelleBancaireSPI passerelleBancaireSPI, TransactionRepositorySPI transactionRepositorySPI) {
