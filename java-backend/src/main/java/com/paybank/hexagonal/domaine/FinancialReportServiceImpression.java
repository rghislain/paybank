...
@Service
public class FinancialReportServiceImpression implements FinancialReportUseCase {

    private final TransactionRepositorySPI transRepo;
    private final JavaMailSender mailSender;

    public FinancialReportServiceImpression(TransactionRepositorySPI transRepo, JavaMailSender mailSender) {
