...
public class ServiceAnnulation implements AnnulerPaiementUseCase {

	private final PasserelleBancaireSPI passerelleBancaireSPI;
    private final PersistancePaiementSPI persistancePaiementSPI;

    public ServiceAnnulation(PasserelleBancaireSPI passerelleBancaireSPI, PersistancePaiementSPI persistancePaiementSPI) {
