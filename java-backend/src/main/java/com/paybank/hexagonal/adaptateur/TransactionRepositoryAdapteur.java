...
@Service
public class TransactionRepositoryAdapteur implements TransactionRepository {
    private final SpringDataTransactionRepository springDataTransactionRepository;

    @Autowired
    private JdbcTemplate jdbcTemplate;
    
    public TransactionRepositoryAdapteur(SpringDataTransactionRepository springDataRepo) {
