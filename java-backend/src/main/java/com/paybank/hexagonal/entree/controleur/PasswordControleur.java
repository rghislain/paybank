...
import com.paybank.hexagonal.jpaRepository.UserAuditLogRepository;
...
public class PasswordControleur {
    ...
    public ResponseEntity<?> updatePassword(
        ...
        try {
            ...
            com.paybank.hexagonal.domaine.model.Role roleEnum = com.paybank.hexagonal.domaine.model.Role.valueOf(request.getAccountIdentifier().toUpperCase());
