...
public class PaiementControleur {
    ...
    private final PaiementService gestionPaiementService;

    public PaiementControleur(PaiementService gestionPaiementService) {
    ...
    public ResponseEntity<?> executerRapprochementBancaire() throws StripeException {
        try {
